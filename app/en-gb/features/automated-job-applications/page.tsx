...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.flashfirejobs.com/en-gb/features/automated-job-applications",
    languages: {
  ...
  openGraph: {
    ...
    url: "https://www.flashfirejobs.com/en-gb/features/automated-job-applications",
    type: "website",
    images: [
      {
