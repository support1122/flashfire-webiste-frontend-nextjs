...
export const metadata: Metadata = {
  title: "Flashfire: AI Job Search Automation Australia",
  description:
  ...
  alternates: {
    canonical: "https://www.flashfirejobs.com/en-au",
    languages: {
  ...
  openGraph: {
    ...
    url: "https://www.flashfirejobs.com/en-au",
    type: "website",
    images: [
      {
...
export default function HomeAU() {
  const schema = {
    ...
    "@type": "WebPage",
    "name": "Flashfire: AI Job Search Automation Australia",
    "url": "https://www.flashfirejobs.com/en-au",
