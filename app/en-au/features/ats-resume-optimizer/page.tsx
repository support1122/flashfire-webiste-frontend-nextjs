...
export const metadata: Metadata = {
  title: "ATS Resume Optimizer & Builder | Flashfire Australia",
  description:
    "Optimize your resume for each job you apply to. Flashfire aligns your experience with every JD so Australian recruiters and ATS systems say yes.",
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: "https://www.flashfirejobs.com/en-au/features/ats-resume-optimizer",
    languages: {
      ...
      "en-AU": "https://www.flashfirejobs.com/en-au/features/ats-resume-optimizer",
  ...
  openGraph: {
    ...
    url: "https://www.flashfirejobs.com/en-au/features/ats-resume-optimizer",
    type: "website",
    images: [
      {
