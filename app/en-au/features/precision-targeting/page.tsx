...
export const metadata: Metadata = {
  title: "Precision Job Targeting: Find Australian Roles",
  description:
  ...
  alternates: {
    canonical: "https://www.flashfirejobs.com/en-au/features/precision-targeting",
    languages: {
  ...
  openGraph: {
    title: "Precision Job Targeting: Find Australian Roles",
    description:
      "Use Flashfire’s targeting engine to surface Australian roles aligned to your background, visa, and compensation needs.",
    url: "https://www.flashfirejobs.com/en-au/features/precision-targeting",
    type: "website",
    images: [
      {
