...
export const metadata: Metadata = {
  title: "Job Application Dashboard & Analytics | Flashfire AU",
  description:
    "See every Australian application, pipeline stage, and conversion metric in one analytics dashboard so you always know what's next.",
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: "https://www.flashfirejobs.com/en-au/features/dashboard-analytics",
    languages: {
  ...
  openGraph: {
    ...
    url: "https://www.flashfirejobs.com/en-au/features/dashboard-analytics",
    type: "website",
    images: [
      {
