...
export const metadata: Metadata = {
  title: "Free ATS Resume Score Checker | Flashfire Australia",
  description: "Check your resume ATS score instantly. Get detailed feedback and improvement tips. Free ATS score checker.",
  alternates: {
    canonical: "https://www.flashfirejobs.com/en-au/ats-score-checker",
    languages: {
  ...
  openGraph: {
    title: "Free ATS Resume Score Checker | Flashfire Australia",
    description: "Check your resume ATS score instantly. Get detailed feedback and improvement tips. Free ATS score checker.",
    url: "https://www.flashfirejobs.com/en-au/ats-score-checker",
    type: "website",
    images: [
      {
