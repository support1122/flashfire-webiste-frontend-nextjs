...
export const metadata: Metadata = {
  title: "Salary Estimator – Realistic Salary Range by Role | Flashfire Australia",
  ...
  alternates: {
    canonical: "https://www.flashfirejobs.com/en-au/salary-estimator",
    languages: {
  ...
  openGraph: {
    title: "Salary Estimator – Realistic Salary Range by Role | Flashfire Australia",
    description: "Estimate a salary range based on role, experience, location, and skill premium. Great for job offer planning and negotiation.",
    url: "https://www.flashfirejobs.com/en-au/salary-estimator",
    type: "website",
  },
