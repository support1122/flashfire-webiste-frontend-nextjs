...
export const metadata: Metadata = {
  title: "Gross Pay Calculator – Weekly, Monthly & Annual | Flashfire Australia",
  description: "Calculate gross pay before taxes from hourly rate, regular hours, overtime, and annual bonus.",
  robots: { index: true, follow: true },
  alternates: {
    canonical: "https://www.flashfirejobs.com/en-au/gross-pay-calculator",
    languages: {
  ...
  openGraph: {
    title: "Gross Pay Calculator – Weekly, Monthly & Annual | Flashfire Australia",
    description: "Calculate gross pay before taxes from hourly rate, regular hours, overtime, and annual bonus.",
    url: "https://www.flashfirejobs.com/en-au/gross-pay-calculator",
    type: "website",
  },
