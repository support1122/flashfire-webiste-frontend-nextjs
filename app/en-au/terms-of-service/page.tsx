...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.flashfirejobs.com/en-au/terms-of-service",
  },
  openGraph: {
    title: "Terms of Service - Flashfire User Agreement",
    description:
      "Read Flashfire's terms of service and user agreement.",
    url: "https://www.flashfirejobs.com/en-au/terms-of-service",
    type: "website",
  },
};

export default function TermsOfServicePageAU() {
  return (
    <>
      <Navbar />
      <TermsOfService />
