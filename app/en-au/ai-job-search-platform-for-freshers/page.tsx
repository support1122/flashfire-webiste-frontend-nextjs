...
export const metadata: Metadata = {
  title: "AI Job Search Platform for Freshers | Flashfire Australia",
  description:
    "Use Flashfire's AI job search platform for freshers to discover internships and entry-level roles that match your skills and goals in Australia.",
  robots: { index: true, follow: true },
  alternates: {
    canonical: "https://www.flashfirejobs.com/en-au/ai-job-search-platform-for-freshers",
    languages: {
