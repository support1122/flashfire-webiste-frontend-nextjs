...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.flashfirejobs.com/en-au/payment-policy",
  },
  openGraph: {
    title: "Payment Policy - Payment Terms & Methods",
    description:
      "Learn about Flashfire's payment policy and accepted payment methods.",
    url: "https://www.flashfirejobs.com/en-au/payment-policy",
    type: "website",
  },
};

export default function PaymentPolicyPageAU() {
  return (
    <>
      <Navbar />
      <PaymentPolicy />
