...
export const metadata: Metadata = {
  title: "Flashfire Product Demo - See the Platform in Action | Australia",
  description:
  ...
  alternates: {
    canonical: "https://www.flashfirejobs.com/en-au/product-demo",
    languages: {
  ...
  openGraph: {
    ...
    url: "https://www.flashfirejobs.com/en-au/product-demo",
    type: "website",
    images: [
      {
...
export default function ProductDemoPageAU() {
  return (
    <>
      <Navbar />
      <HomePageVideo />
