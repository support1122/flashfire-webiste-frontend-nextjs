...
export const metadata: Metadata = {
  title: "Salary Comparison – Compare Two Job Offers | Flashfire Australia",
  ...
  alternates: {
    canonical: "https://www.flashfirejobs.com/en-au/salary-comparison",
    languages: {
  ...
  openGraph: {
    title: "Salary Comparison – Compare Two Job Offers | Flashfire Australia",
    description: "Compare two job offers side by side including salary, bonus, benefits, and commute costs to find the better total value.",
    url: "https://www.flashfirejobs.com/en-au/salary-comparison",
    type: "website",
  },
