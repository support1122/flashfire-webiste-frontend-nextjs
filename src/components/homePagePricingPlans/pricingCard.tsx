...
export default function PricingCard({
  ...
  // Parse base price from string (handles "$199", "CA$279", "US$199" or "£149")
  ...
  // Get currency symbol. Check the multi-character prefixes first so "CA$" and
  // "US$" are not matched as a plain "$".
