                    ...
                    <>
                        {popupCollapsed ? (
                            <button
                                ...
                                className="fixed bottom-6 right-4 sm:bottom-[6rem] sm:right-7 z-50 p-3 sm:p-4 bg-white rounded-full shadow-[0_8px_30px_rgba(0,0,0,0.12)] border border-gray-100 hover:bg-gray-50 transition-colors"
